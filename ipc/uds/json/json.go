/*
Package json provides a client that can be used on a *uds.Client or *uds.Conn to send JSON values.
...
// New is the constructor for ChunkReader. rwc must be a *uds.Client or *uds.Conn.
