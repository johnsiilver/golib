...
func init() {
	proto.RegisterType((*Input)(nil), "input.v2.Input")
	proto.RegisterType((*User)(nil), "input.v2.User")
	proto.RegisterType((*Resource)(nil), "input.v2.Resource")
	proto.RegisterType((*Perms)(nil), "input.v2.Perms")
	proto.RegisterType((*Output)(nil), "input.v2.Output")
}
...
var fileDescriptor_75b0773ef7c1937b = []byte{
	...
	,
}
...
func (c *recorderClient) Record(ctx context.Context, in *Input, opts ...grpc.CallOption) (*Output, error) {
	out := new(Output)
	err := c.cc.Invoke(ctx, "/input.v2.Recorder/Record", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Recorder_Record_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/input.v2.Recorder/Record",
	}
